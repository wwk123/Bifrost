...
import { ArrowLeft, Trophy, Crown, Medal, TrendingUp, Award, Zap, Calendar, Users, Star } from 'lucide-react';
...
export default function MonthlyLeaderboardPage() {
  ...
  const monthRewards = [
    { rank: '1st', reward: '25,000 BNC + 月度王者徽章 + 专属头衔 + NFT', color: 'text-yellow-400' },
    { rank: '2nd', reward: '15,000 BNC + 亚军徽章 + NFT', color: 'text-gray-300' },
    { rank: '3rd', reward: '10,000 BNC + 季军徽章 + NFT', color: 'text-amber-600' },
    { rank: '4-10', reward: '2,500 BNC + 成就徽章', color: 'text-info' },
    { rank: '11-30', reward: '1,000 BNC', color: 'text-success' },
    { rank: '31-100', reward: '500 BNC', color: 'text-warning' }
  ];
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="glass-panel relative overflow-hidden rounded-3xl border border-bifrost-primary/30 px-8 py-8">
        ...
        <div className="relative">
          ...
          <div className="flex items-center gap-4">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-bifrost-primary/30 to-purple-500/30">
              <Star className="h-10 w-10 text-bifrost-primary" />
            </div>
            <div>
              <h1 className="text-4xl font-bold text-white">月榜排行</h1>
              <p className="text-lg text-text-secondary">
                Monthly Leaderboard · 本月收益王者争霸
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-4">
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-3">
              ...
              <div className="mt-1 text-2xl font-bold text-bifrost-primary">120,000 BNC</div>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-3">
              ...
              <div className="mt-1 text-2xl font-bold text-success">+28.6%</div>
            </div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-3">
              ...
              <div className="mt-1 text-2xl font-bold text-warning">12天后</div>
            </div>
          </div>
        </div>
      </div>
            ...
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-full border px-6 py-2.5 text-sm font-semibold transition-all ${
                selectedCategory === cat.id
                  ? 'border-bifrost-primary/50 bg-bifrost-primary/20 text-white'
      ...
      <div className="glass-panel rounded-3xl border border-white/5 p-8">
        <h2 className="mb-6 text-2xl font-bold text-white">本月荣耀榜</h2>
          ...
          {topThree[1] && (
            ...
            >
              ...
              <div className="w-full rounded-2xl border border-gray-300/30 bg-gradient-to-br from-gray-300/10 to-gray-400/10 p-6 text-center">
                ...
                <div className="mt-4 rounded-full border border-gray-300/30 bg-gray-300/10 px-3 py-2 text-xs font-semibold text-gray-300">
                  15,000 BNC + 亚军徽章
                </div>
              </div>
            </motion.div>
          ...
          {topThree[0] && (
            ...
            >
              ...
              <div className="w-full rounded-2xl border border-yellow-400/50 bg-gradient-to-br from-yellow-400/10 to-yellow-500/10 p-6 text-center shadow-[0_0_20px_rgba(251,191,36,0.2)]">
                ...
                <div className="mt-4 rounded-full border border-yellow-400/50 bg-yellow-400/20 px-3 py-2 text-xs font-semibold text-yellow-400">
                  👑 25,000 BNC + 月度王者
                </div>
              </div>
            </motion.div>
          ...
          {topThree[2] && (
            ...
            >
              ...
              <div className="w-full rounded-2xl border border-amber-600/30 bg-gradient-to-br from-amber-600/10 to-amber-700/10 p-6 text-center">
                ...
                <div className="mt-4 rounded-full border border-amber-600/30 bg-amber-600/10 px-3 py-2 text-xs font-semibold text-amber-600">
                  10,000 BNC + 季军徽章
                </div>
              </div>
            </motion.div>
      ...
      {/* Monthly Highlights */}
      <div className="glass-panel rounded-3xl border border-white/5 p-6">
        <h2 className="mb-6 text-xl font-bold text-white">本月亮点</h2>

        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-success/30 bg-gradient-to-br from-success/10 to-success/5 p-4">
            <div className="mb-2 flex items-center gap-2">
              <TrendingUp className="h-5 w-5 text-success" />
              <span className="text-sm font-semibold text-success">最高单日收益</span>
            </div>
            <div className="text-2xl font-bold text-white">+8.9%</div>
            <div className="mt-1 text-xs text-text-secondary">由 DeFi_Master 创造</div>
          </div>

          <div className="rounded-xl border border-warning/30 bg-gradient-to-br from-warning/10 to-warning/5 p-4">
            <div className="mb-2 flex items-center gap-2">
              <Zap className="h-5 w-5 text-warning" />
              <span className="text-sm font-semibold text-warning">最佳策略</span>
            </div>
            <div className="text-2xl font-bold text-white">智能对冲</div>
            <div className="mt-1 text-xs text-text-secondary">平均收益 +6.2%</div>
          </div>

          <div className="rounded-xl border border-info/30 bg-gradient-to-br from-info/10 to-info/5 p-4">
            <div className="mb-2 flex items-center gap-2">
              <Users className="h-5 w-5 text-info" />
              <span className="text-sm font-semibold text-info">活跃用户</span>
            </div>
            <div className="text-2xl font-bold text-white">8,432</div>
            <div className="mt-1 text-xs text-text-secondary">较上月 +23%</div>
          </div>
        </div>
      </div>
      ...
      {/* Rewards Table */}
      <div className="glass-panel rounded-3xl border border-white/5 p-6">
        <h2 className="mb-6 text-xl font-bold text-white">本月奖励规则</h2>

        <div className="space-y-3">
          {monthRewards.map((item, index) => (
            <div
              key={index}
        ...
        <div className="mt-6 rounded-xl border border-bifrost-primary/30 bg-bifrost-primary/5 p-4">
          <p className="text-sm text-text-secondary">
            🎁 所有月榜 Top 100 玩家将获得专属 NFT 徽章，可在个人主页展示并获得永久收益加成！
          </p>
        </div>
      </div>
    </div>
